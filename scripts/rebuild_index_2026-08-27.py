#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""2026-08-27 索引同步：以磁盘 390 份报告为权威源。
本批 = 4 份新增（tt-a1i/archify / browser-use/browser-use / VoltAgent/awesome-agent-skills / ConardLi/garden-skills）。
计数 386→390。复用 2026-08-26 磁盘权威重建逻辑。STALE = 空（无删除/改名）。
"""
...
CURATED = {
 "tt-a1i/archify": dict(repo="tt-a1i/archify", file="tt-a1i-archify-深度调研.md",
    desc="Agent Skill：把代码库/系统描述变成可交互、可验证、可分享的技术架构图（自包含 HTML + 类型化 JSON IR + 确定性校验）",
    stars="17,511", date="2026-08-27", domain="AI 编码 / Skill 技能"),
 "browser-use/browser-use": dict(repo="browser-use/browser-use", file="browser-use-browser-use-深度调研.md",
    desc="让 AI Agent 像人一样操作浏览器的开源库 + 云托管 Agent（DOM 语义抽象 + 自循环 + ChatBrowserUse 多 LLM，Odysseys #1）",
    stars="110,829", date="2026-08-27", domain="AI Agent / 助手框架"),
 "VoltAgent/awesome-agent-skills": dict(repo="VoltAgent/awesome-agent-skills", file="VoltAgent-awesome-agent-skills-深度调研.md",
    desc="由顶尖工程团队与社区手工精选的 Agent Skills 清单（1497+，非 AI-slop），skills 生态发现入口与信任层",
    stars="32,554", date="2026-08-27", domain="AI 编码 / Skill 技能"),
 "ConardLi/garden-skills": dict(repo="ConardLi/garden-skills", file="ConardLi-garden-skills-深度调研.md",
    desc="ConardLi 出品的生产级 Agent Skills 合集（5 个设计引擎级 skill，硬协作检查点 + 可复现 SHA-256 安装）",
    stars="10,862", date="2026-08-27", domain="AI 编码 / Skill 技能"),
}
