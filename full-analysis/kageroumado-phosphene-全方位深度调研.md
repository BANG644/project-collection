...
- PR 
- #12 [OPEN] Fix multi-monitor wallpaper flip after loop boundary
- PR 
- #7 [CLOSED] Capture per-context videoID in variantSelector (fixes #1)
- PR 
- #6 [MERGED] Document headless build instructions
- PR 
- #5 [OPEN] Clean up renderer layers on stop
- PR 
- #4 [OPEN] Rotate extension logs
