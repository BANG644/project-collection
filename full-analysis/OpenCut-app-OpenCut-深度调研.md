...
`OpenCut-app/OpenCut` 是一个video editor / open-source CapCut alternative项目：开源 CapCut 替代品，面向视频剪辑的现代 Web/桌面应用。

> 核心判断：价值在开源视频剪辑工作流和可自托管/可二次开发。但它不能只按 README 口号理解，必须同时看真实源码结构、权限边界、维护节奏和实际任务验证。视频编辑涉及性能、时间线稳定性、编码导出和素材版权。
...
| 类型 | video editor / open-source CapCut alternative |
| 核心价值 | 价值在开源视频剪辑工作流和可自托管/可二次开发 |
| 主要风险 | 视频编辑涉及性能、时间线稳定性、编码导出和素材版权 |
...
| 方案 | 优势 | 风险 |
|---|---|---|
| OpenCut-app/OpenCut | 垂直场景明确，能快速试用 | 需要验证维护质量和真实边界 |
